...
namespace App.Application.Caching
{
    ...
    public static class CacheExtensions
    {
        ...
        {
            return await GetAsync(cacheManager, key, int.MaxValue, acquire);
        }
        public static T Get<T>(this ICacheManager cacheManager, string key, Func<T> acquire)
        {
            return Get(cacheManager, key, int.MaxValue, acquire);
        }

        //public static T GetData<T>(this ICacheManager cacheManager, string key, Func<T> acquire)
        //{
