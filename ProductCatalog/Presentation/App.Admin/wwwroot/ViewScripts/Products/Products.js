    ...
    var table = $('.table').DataTable(
        {
            ...
            "buttons": [
                {
                    "extend": 'excelHtml5', "title": Resources.SharedResource.products, "text": '<span>' + Resources.SharedResource.exportexcel + ' <i class="icon-file-excel"></i></span>', "className": 'dt-button buttons-print btn btn-light', "exportOptions":
                    {
                        "columns": ':visible'
                    }
                },
            ...
            "columnDefs": [
                ...
                {
                    "targets": [8], // Replace with the index of the column to hide
                    "visible": isAdmin
                }
            ],
            "order": [
            ...
            "ajax":
            {
                "url": "/Products/LoadData?StatusId="
                    + $("#StatusId").val()
            ...
            "columns": [
                { "data": "Title" },
                { "data": "CategoryName" },
                { "data": "CreateByUserName" },

                { "data": "Price" },
                { "data": "Duration" },
                { "data": "StartDate" },

                { "data": "CreateDateMonth" },
                {
                    "mData": null,
                    "bSortable": false,
                    "mRender": function (o) {
                ...
                
                {
                    ...
                    "mRender": function (o) {
                        return '<div class="list-icons">'
                            + '<a href="/Products/AddEdit/' + o.Id + '" class="list-icons-item text-primary-600" data-popup="tooltip" title="' + Resources.SharedResource.edit + '"><i class="icon-pencil"></i></a> &nbsp;'
...
function Status(id, Status) {
    $.post('/Products/Status?id=' + id + "&status=" + Status , function (response) {
        if (response == true) {
